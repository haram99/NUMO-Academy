...
# ---------------------------------------------------------
# تنسيقات CSS: حل مشكلة الهامش العلوي وتفعيل دوران الشعار أفقياً
# ---------------------------------------------------------
st.markdown(
    f"""
    <style>
    ...
    /* زيادة المسافة العلوية لمنع تداخل العنوان مع شريط Streamlit العلوي */
    .block-container {{
    ...
    /* دوران أفقي حقيقي ثلاثي الأبعاد (يمين ويسار) حول المحور Y */
    .sphere-logo {{
        width: 110px;
        height: 110px;
        border-radius: 50%;
...
# ---------------------------------------------------------
# رأس الصفحة (إصلاح التداخل وتنسيق الأعمدة)
# ---------------------------------------------------------
...
if page == "🏠 الرئيسية":
    ...
    with st.form("competition_form"):
        ...
        q3 = st.radio("3. أي من الآتي يمثل ممارسة صحيحة في الأمن السيبراني الشخصي؟", ["استخدام كلمة مرور موحدة وسهلة", "تفعيل المصادقة الثنائية (2FA) وتحديث البرمجيات دورياً", "النقر على الرابط غير المعروف"], index=None, key="q3_radio")
